...
class TestFabman(unittest.TestCase):  # pylint: disable=missing-class-docstring
    ...
    def test_init_no_api_key(self, m):  # pylint: disable=missing-function-docstring, unused-argument
    ...
    def test_init_empty_api_key(self, m):  # pylint: disable=missing-function-docstring, unused-argument
        with self.assertRaises(
            ValueError,
            msg="No access token provided"
        ):
    ...
    def test_init_warnings_for_http(self, m):  # pylint: disable=missing-function-docstring, unused-argument
    ...
    def test_init_warnings_for_bad_url(self, m):  # pylint: disable=missing-function-docstring, unused-argument
        with warnings.catch_warnings(record=True):
